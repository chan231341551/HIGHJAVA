...
//		for(Student student1 : memList) {
//			int i = 1;
//			for(Student student2 : memList) {
...
//		
		...
		System.out.println("총점의 내림차순으로 정렬 후(총점이 같으면 학번 내림차수) : ");
		for(Student mem : memList) {
			System.out.println(mem);
		}
		System.out.println("-----------------------------------------------------");
...
class Student implements Comparable<Student>{ //Comparable => 정렬하고싶은 객체 에 선언 
